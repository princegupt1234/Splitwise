...
function applyTheme(resolved) {
  ...
  if (resolved === 'dark') {
    ...
    root.style.setProperty('--btn-secondary-border','#e5e7eb');
    root.style.setProperty('--btn-secondary-bg-hover','rgba(17,19,24,0.08)');
    root.style.setProperty('--btn-secondary-border-hover','#d1d5db');
    root.style.setProperty('--input-bg',          'rgba(255,255,255,1)');
